	...
	<div>
		<div class="crumbs">
			<el-breadcrumb separator="/">
				<el-breadcrumb-item><i class="el-icon-lx-copy"></i> Home >> Dashboard</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
				...
				<el-card shadow="hover" :body-style="{ padding: '0px' }">
					<div class="grid-content grid-con-1">
						...
						<div class="grid-cont-right">
							...
							<div class="grid-title">Active Projects</div>
						</div>
					</div>
				</el-card>
			</el-col>
			<el-col :span="8">
				<el-card shadow="hover" :body-style="{ padding: '0px' }">
					<div class="grid-content grid-con-2">
						...
						<div class="grid-cont-right">
							<div class="grid-num">A,C1,C3</div>
							<div class="grid-title">Zoning Areas</div>
						</div>
					</div>
				</el-card>
			</el-col>
			<el-col :span="8">
				<el-card shadow="hover" :body-style="{ padding: '0px' }">
					<div class="grid-content grid-con-3">
						...
						<div class="grid-cont-right">
							<div class="grid-num">173</div>
							<div class="grid-title">Units Pending</div>
						</div>
					</div>
				</el-card>
			</el-col>
		...
		<el-row :gutter="20">
			...
			<el-col :span="12">
				<el-card shadow="hover">
					<com-bar2 @click.native="navigateToBar2"></com-bar2>
...
import ComBar2 from '../common/CBar-2.vue';
export default {
	name: 'dashboard',
	data() {
		return {
